                                ...
                                <ul class="list-group mb-3 list-group-flush">
                                    ...
                                    <li class="list-group-item px-0">
                                        ...
                                        <div class="input-group" >
                                            ...
                                            @endif
                                            <input type="text" id="mulai-{{ $al->kode_barang_aset }}" name="ts_mulai[{{ $i }}]" class="form-control tspicker" value="{{ $timestamp_alat[$al->kode_barang_aset]['timestamp_mulai'] ?? '' }}" readonly>
                                    ...
                                    <li class="list-group-item px-0">
                                        ...
                                        <div class="input-group" >
                                            ...
                                            @endif
                                            <input type="text" id="akhir-{{ $al->kode_barang_aset }}" name="ts_akhir[{{ $i }}]" class="form-control tspicker" value="{{ $timestamp_alat[$al->kode_barang_aset]['timestamp_akhir'] ?? '' }}" readonly>
