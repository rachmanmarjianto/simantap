						...
						<div class="card">
							...
							<div class="card-body">
								<div class="basic-form">
									<form action = "{{ route('unit_kerja_simpan') }}" method="POST">
										@csrf
										...
										<div class="form-group row">
											...
											<div class="col-sm-10">
												<input type="text" class="form-control" name = "type_unit_kerja">
											</div>
										</div>
										<div class="form-group row">
											...
											<div class="col-sm-10">
												<select class="form-control" id="sel2" name = "idfakultas">
													...
													@foreach($fakultas as $row)
														<option value = "{{ $row->idfakultas }}">{{ $row->nama_fakultas }}</option>
													@endforeach
												</select>
											</div>
										</div>
											...
											<div class="col-sm-10">
												<select class="form-control" id="sel3" name = "idprogram_studi">
													...
													@foreach($program_studi as $row)
														<option value = "{{ $row->idprogram_studi }}">{{ $row->nama_program_studi }}</option>
													@endforeach
												</select>
											</div>
										</div>
