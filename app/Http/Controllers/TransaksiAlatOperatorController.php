...
class TransaksiAlatOperatorController extends Controller
{
	public function index()
	{
		$list_transaksi_alat = TransaksiAlat::all();
		return view('transaksi_alat_operator.index', compact('list_transaksi_alat') );
	}
	...
	public function tambah()
	{
		...
		return view('transaksi_alat_operator.tambah', compact('unit', 'layanan') );
	}
	...
	public function edit ($id)
	{
		...
		return view('transaksi_alat_operator.edit', compact('transaksi_alat', 'id', 'unit', 'layanan', 'alat') );
	}
